...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.equipmentLoan.title_singular') }}
    </div>
    <div class="card-body">
        <form action="{{ route('admin.equipment-loans.store') }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <select name="equipment_id" id="equipment_id" class="form-select select2 {{ $errors->has('equipment_id') ? 'is-invalid' : '' }}" required>
                    @foreach($equipment as $id => $name)
                        <option value="{{ $id }}" {{ old('equipment_id') == $id ? 'selected' : '' }}>{{ $name }}</option>
                    @endforeach
                </select>
            ...
            <div class="mb-3">
                ...
                <input type="text" id="borrower_name" name="borrower_name" class="form-control {{ $errors->has('borrower_name') ? 'is-invalid' : '' }}" value="{{ old('borrower_name') }}" required>
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" id="start_time" name="start_time" class="form-control flatpickr-datetime {{ $errors->has('start_time') ? 'is-invalid' : '' }}" value="{{ old('start_time') }}" required>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" id="end_time" name="end_time" class="form-control flatpickr-datetime {{ $errors->has('end_time') ? 'is-invalid' : '' }}" value="{{ old('end_time') }}" required>
